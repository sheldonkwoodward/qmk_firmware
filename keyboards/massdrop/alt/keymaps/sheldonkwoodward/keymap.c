...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_LCBR] = ACTION_TAP_DANCE_DOUBLE(KC_LCBR, KC_LBRC),
    [TD_RCBR] = ACTION_TAP_DANCE_DOUBLE(KC_RCBR, KC_RBRC)
};

// key layout
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_65_ansi_blocker(KC_GESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, KC_DEL, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, TD(TD_LCBR), TD(TD_RCBR), TD(TD_PIPE), KC_MUTE, KC_MINS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, TD(TD_COLN), TD(TD_DQUO), KC_ENT, KC_VOLU, KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSPC, KC_RCBR, KC_VOLD, LCTL_T(KC_EQL), LALT_T(KC_LBRC), KC_LGUI, LT(2,KC_SPC), LT(2,KC_EQL), LT(3,KC_RBRC), KC_NO, KC_NO, KC_NO),
